...
//
//        logger.info("Scrapping Letterboxd rating for movie: {} (URL: {})", movieTitle, url);
//
//        try {
...
//                    .get();
//
//            Element ratingElement = doc.select("a[href$=/ratings/].tooltip.display-rating").first();
//
//            if (ratingElement != null) {
//                LetterboxdMovieDto movieDto = new LetterboxdMovieDto();
//                movieDto.setTitle(movieTitle);
//                movieDto.setRating(Float.parseFloat(ratingElement.text()));
//
//                logger.info("Successfully scraped rating for {}: {}", movieTitle, movieDto.getRating());
//                return movieDto;
//            } else {
//                logger.warn("No rating element found for movie {}", movieTitle);
//                return null;
//            }
//        } catch (IOException e) {
